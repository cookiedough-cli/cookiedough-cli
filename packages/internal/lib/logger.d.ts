...
export declare function _log(data: ValidLogData): void;
export declare function _warn(data: ValidLogData): void;
export declare function _error(data: ValidLogData): void;
export declare function useLog(data: ValidLogData, type?: LogType, filePath?: LogFilePath): void;
export declare function useDataLog(o: object | string): void;
